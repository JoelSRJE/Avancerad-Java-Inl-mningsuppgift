            ...
            switch (commandInput) {
                ...
                case "3" -> {
                    ...
                    try {
                        ...
                        if (choice >= 1 && choice <= accounts.size()) {
                            UUID selectedID = accounts.get(choice - 1).getAccountID();
                            accountService.deleteAccount(selectedID);
                            System.out.println("Deleted account: " + accounts.get(choice - 1).getAccountName());

                            if (currentAccountID != null && currentAccountID.equals(selectedID)) {
